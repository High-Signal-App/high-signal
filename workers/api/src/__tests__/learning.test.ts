...
const snapshot: BriefSnapshot = {
  ...
  stocks: [
    {
      ...
      headline: 'Acme adoption is accelerating',
  ...
  ideas: [
    {
      title: 'Build a verification layer',
      description: 'Teams need evidence they can inspect.',
      source: 'community',
      region: 'global',
      evidenceUrls: [{ url: 'https://example.com/idea' }],
      subreddit: 'SaaS',
  ...
  trends: [
    {
      ...
      description: 'Operators are choosing local control.',
      subreddit: 'selfhosted',
      region: 'global',
      evidenceUrls: [{ url: 'https://example.com/trend' }],
      surfacedAt: '2026-07-13T06:00:00.000Z',
    },
  ],
  ...
  improvements: [
    {
      ...
      surfacedAt: '2026-07-13T00:00:00.000Z',
    },
  ],
};
