...
CATALOG: list[CatalogEntry] = [
    ...
    CatalogEntry("youtube", "YouTube discovery + transcripts", "technology", "optional-key:YOUTUBE_API_KEY", False, 7, "thematic", "video title, view count, channel, transcript snippet when available", "recent"),
