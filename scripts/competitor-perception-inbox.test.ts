...
import mentions from '../fixtures/competitor-perception-mentions.json' with { type: 'json' };
import {
  buildCompetitorPerceptionInbox,
  renderCompetitorPerceptionMarkdown,
} from './competitor-perception-inbox';
...
assert.match(
  report.monthlyReportReadyRecommendation,
  /source-trail|report|roadmap|source\/evidence/i
);
