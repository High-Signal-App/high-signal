...
export const COMPETITOR_PROMPT_TEMPLATES: CompetitorPromptTemplate[] = [
  ...
  },
  {
    ...
    template:
      'What tools do engineering leaders recommend for issue tracking instead of {competitor}?',
  },
  ...
  },
  {
    ...
    template:
      "Is there a cheaper option than {brand} that still handles {competitor}'s core use case?",
  },
...
export function hydratePrompt(
  ...
  return template.template.replaceAll('{brand}', brand).replaceAll('{competitor}', competitor);
}
