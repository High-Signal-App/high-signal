...
export const SEED_PRODUCTS: SeedProduct[] = [
  // --- Technology --------------------------------------------------------
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: "Publish a 'Linear vs Jira' comparison page with structured data.",
        priority: 'high',
      },
      {
        area: 'pricing',
        task: 'Add enterprise pricing tier breakdown with seat economics.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: "Document the 'when not to use Vercel' negative-case page.",
        priority: 'medium',
      },
      {
        area: 'policies',
        task: 'Surface SOC-2 / GDPR posture in an agent-readable schema.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'proof',
        task: 'Add named customer case studies with quantified outcomes.',
        priority: 'high',
      },
  ...
  },
  {
    ...
    improvements: [
      {
        area: 'positioning',
        task: "Lead with 'for whom' on the homepage — currently feature-led.",
        priority: 'high',
      },
      {
        area: 'reviews',
        task: 'Collect third-party reviews on G2 / Reddit threads.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Comparison page vs Supabase, RDS, and PlanetScale.',
        priority: 'high',
      },
      {
        area: 'transaction readiness',
        task: 'Make pricing self-serve up to 50 GB without contact-sales.',
        priority: 'low',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'policies',
        task: 'Public SLA + uptime history (incidents page is too quiet).',
        priority: 'high',
      },
      {
        area: 'proof',
        task: "Case studies for the 'edge compute beats us-east-1' positioning.",
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'policies',
        task: 'Make data-retention & training-data posture more agent-readable.',
        priority: 'high',
      },
      {
        area: 'pricing',
        task: 'Publish predictable per-1M-tokens pricing comparison vs OpenAI.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'transaction readiness',
        task: 'Clarify productisation path for the Gemini API line.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Inference Endpoints vs Modal / Replicate / Fireworks comparison.',
        priority: 'medium',
      },
      {
        area: 'policies',
        task: 'Surface enterprise security tier requirements in self-serve flow.',
        priority: 'low',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Perplexity vs ChatGPT Search agent-readable comparison.',
        priority: 'high',
      },
  ...
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Razorpay vs Stripe-India / Cashfree decision tree.',
        priority: 'high',
      },
      {
        area: 'docs',
        task: 'Integration time-to-first-payment in the docs hero.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Compare Zerodha vs Groww / Upstox / Dhan with fees explicit.',
        priority: 'high',
      },
      {
        area: 'policies',
        task: 'Surface SEBI compliance + support SLA on the help-center hero.',
        priority: 'low',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Plus vs Standard plan side-by-side, with revenue thresholds.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'pricing',
        task: 'Datadog billing surprises are notorious — publish predictable-spend guidance.',
        priority: 'high',
      },
      {
        area: 'comparisons',
        task: 'Datadog vs Grafana Cloud + Cloudflare Workers observability.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'docs',
        task: 'Consolidate Workers vs Pages vs OpenNext guidance.',
        priority: 'high',
      },
    ],
  },
  // --- Startups ----------------------------------------------------------
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Ramp vs Brex vs Mercury vs Rho comparison page.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'policies',
        task: 'Make the partner-bank deposit insurance posture obviously cited.',
        priority: 'high',
      },
      {
        area: 'transaction readiness',
        task: 'Self-serve flow for non-US founders.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'proof',
        task: 'Customer revenue / pipeline outcomes with numbers, not logos alone.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Attio vs HubSpot vs Pipedrive with switching-cost honesty.',
        priority: 'high',
      },
  ...
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'StackBlitz vs CodeSandbox vs Replit + WebContainers explainer.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'policies',
        task: 'Enterprise security posture for team rollouts.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'policies',
        task: 'Telemetry & data posture is the #1 critique — make it citeable.',
        priority: 'high',
      },
      {
        area: 'comparisons',
        task: 'Warp vs iTerm2 + Oh-My-Zsh feature comparison.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Browserbase vs Apify vs Playwright cloud comparison.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'positioning',
        task: 'Hero is feature-led; lead with the doc-AI buyer mission.',
        priority: 'high',
      },
      {
        area: 'proof',
        task: 'Replace logos-only social proof with customer outcomes.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'policies',
        task: 'Driver pay / commission transparency is the recurring complaint.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Nubank vs Inter vs Itaú decision tree for tech buyers.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Grab vs Gojek line-by-line, not corporate-speak.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'transaction readiness',
        task: 'Seller-onboarding cost transparency in English.',
        priority: 'medium',
      },
    ],
  },
  // --- Finance ----------------------------------------------------------
  {
    ...
    improvements: [
      {
        area: 'policies',
        task: 'Make dispute / chargeback policy more agent-readable.',
        priority: 'low',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Robinhood vs Fidelity vs Schwab side-by-side on fees + tools.',
        priority: 'high',
      },
      {
        area: 'policies',
        task: 'Order-flow practices need a clear public explainer.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Wise Business vs Revolut Business vs Mercury.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'policies',
        task: 'Account-freeze incident postings are still the recurring critique.',
        priority: 'high',
      },
    ],
  },
  ...
  },
  {
    ...
    improvements: [
      {
        area: 'policies',
        task: 'RBI compliance posture should be the trust-page lead.',
        priority: 'high',
      },
      {
        area: 'comparisons',
        task: 'Paytm vs PhonePe vs GooglePay fee + KYC comparison.',
        priority: 'medium',
      },
    ],
  },
  // --- East Asia ---------------------------------------------------------
  {
    ...
    improvements: [
      {
        area: 'transaction readiness',
        task: 'Make WeChat Pay onboarding for non-CN merchants legible to agents.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'policies',
        task: 'Data-localisation posture per market is the recurring question.',
        priority: 'high',
      },
      {
        area: 'comparisons',
        task: 'TikTok-for-Business vs Meta ads decision tree for SMBs.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Alibaba Cloud vs AWS / GCP in SEA market head-to-heads.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'proof',
        task: 'HBM3E customer wins + ramp data deserve a public dashboard.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'positioning',
        task: 'English-language positioning is unclear vs the JP-market story.',
        priority: 'high',
      },
    ],
  },
  // --- MENA --------------------------------------------------------------
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Careem Pay vs STC Pay vs Tabby for UAE/KSA merchants.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'proof',
        task: 'Repayment-quality numbers vs Tabby would close the trust gap.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Anghami vs Spotify catalogue + artist-payout transparency.',
        priority: 'medium',
      },
    ],
  },
  // --- Africa ------------------------------------------------------------
  {
    ...
    improvements: [
      {
        area: 'policies',
        task: 'Regulator-action history needs an authoritative, dated public log.',
        priority: 'high',
      },
      {
        area: 'comparisons',
        task: 'Flutterwave vs Paystack vs Cellulant for cross-border SMB merchants.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'docs',
        task: 'Daraja API quickstart could be much friendlier for indie devs.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'transaction readiness',
        task: 'Self-serve flow for business accounts across NG/KE/UG/RW.',
        priority: 'high',
      },
    ],
  },
  // --- Oceania -----------------------------------------------------------
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Cloud-tier pricing post-Data-Center deprecation needs a clear calculator.',
        priority: 'high',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Canva Enterprise vs Figma Slides vs Adobe Express side-by-side.',
        priority: 'medium',
      },
    ],
  },
  {
    ...
    improvements: [
      {
        area: 'comparisons',
        task: 'Airwallex vs Wise Business vs Mercury for global startups.',
        priority: 'high',
      },
    ],
  },
