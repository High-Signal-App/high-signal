...
| Digg technology clusters | Implemented locally; release pending | Documented ranked, rolling, today, and rising cluster feeds | Derived early-attention and narrative-velocity overlay. May prioritize investigation or brief prominence; never counts as independent evidence or raises confidence. |
